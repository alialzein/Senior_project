...
public class AllStudentsAccount extends AppCompatActivity {
    private RecyclerView allStudentsList;
    private DatabaseReference all_students_Ref;
    private DatabaseReference AddStudentRequestReference;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AddStudentRequestReference = FirebaseDatabase.getInstance().getReference().child("classrooms");
    ...
    private void RemoveStudent() {
        AddStudentRequestReference.child(instructorID).child("Student_In_Classroom").child(student_id)
    ...
    private void AddStudent() {
        AddStudentRequestReference.child(instructorID).child("Student_In_Classroom").child(student_id)
                .child("CURRENT_STUDENT_STATE").setValue("in_classroom").addOnCompleteListener(new OnCompleteListener<Void>() {
            @Override
            public void onComplete(@NonNull Task<Void> task) {
                if (task.isSuccessful()) {
